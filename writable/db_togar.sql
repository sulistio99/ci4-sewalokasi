...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Bulan Mei 2023 pada 04.56
...
INSERT INTO `tb_hunian` (`id_hunian`, `nama_hunian`, `nama_pemilik`, `id_kategori`, `deskripsi_hunian`, `status_hunian`, `harga_hunian`, `alamat_hunian`, `info`, `luas_tanah`, `luas_bangunan`, `gambar`) VALUES
(14, 'Kontrakan coklat A01', 'Basyar', 2, '2 Kamar tidur, 1 dapur, 1 kamar mandi, 1 ruang tamu, tempat parkiran', 'Available', 1000000, 'Jl. Keadilan Bau 2', 'Jalan Pas Pinggir Jalan Raya, Strategis dekat warung makan dll.', 0, 0, 'hunian1.jpg'),
(16, 'Kontrakan coklat A02', 'Togar', 1, '2 Kamar tidur, 1 dapur, 1 kamar mandi, 1 ruang tamu, tempat parkiran, ', 'Sold out', 1000000, 'Jl. Keadilan Bau 1', 'Dekat Masjid', 45, 30, 'hunian2.jpg'),
(17, 'Kontrakan abu-abu B01', 'Togar', 1, '2 Kamar tidur lengkap dengan kasur, 1 dapur, 1 kamar mandi, 1 ruang tamu', 'Sold Out', 1250000, 'Jl. Keadilan Bau 3', 'Dekat Warung Makan Sate Iga', 0, 0, 'hunian3.jpg'),
(18, 'Kontrakan abu-abu B02', 'H.Abdullah Nurdin', 2, '2 Kamar tidur  + AC, 1 dapur, 1 kamar mandi, 1 ruang tamu', 'Available', 1500000, 'Kesehatan Makmur No.9', 'Halaman Depan Ada Pos', 68, 84, 'hunian4.jpg'),
(19, 'Kontrakan abu-abu C01', 'Togar', 1, '2 Kamar tidur, 1 dapur, 1 kamar mandi, 1 ruang tamu', 'Sold Out', 1300000, 'Jl. Keadilan Bau 4', 'Tempat Parkiran Luas', 0, 0, 'hunian2.jpg'),
(20, 'Kontrakan abu-abu C02', 'Hj.Aceng', 2, '2 Kamar tidur + AC, 1 dapur, 1 kamar mandi, 1 ruang tamu', 'Available', 1500000, 'Jl. Makmur Sejahtera No.1', 'Lahan Depan Luas', 108, 39, 'hunian3.jpg'),
(22, 'Kos Pria Enteran', 'Togar', 1, 'Kamar Mandi Dalam, Kamar, AC', 'Available', 550000, 'Jalan Keadilan No.9 KM.2', 'Lokasi Aman', 80, 182, '1684604155_7e4fa00bd8df5fb09633.jpg'),
(23, 'Kos Wanita Enteran', 'Togar', 1, 'WC Dalam, Ac, Dapur', 'Available', 750000, 'Jalan Daya No.2 KM.7', 'Lokasi Aman Dan Strategis', 36, 30, '1684604235_2916b7a21a32007f3a00.jpg'),
(24, 'KOS Pria Elegan Luas', 'Abur Malik Anwar', 1, 'WC Dalam, Dapur, Parkiran, AC', 'Available', 670000, 'Jl. Bau bau selatan KM.4', 'Lahan Parkiran Luas Samping Kos', 38, 30, '1684651141_4cbe653ef9a62806c996.jpg'),
(25, 'KOS Pria Elegan Luas', 'Abur Malik Anwar', 1, 'WC Dalam, Ac, Dapur', 'Available', 750000, 'Jl. Bau bau utara KM.4', 'Parkiran Luas Area Kos', 0, 0, '1684651205_f346c7ec476130f9be7b.jpg'),
(26, 'Kontrakan Elit Luas', 'Agung Ginanjar', 2, 'Kamar 2, Wc Dalam, Dapur, Pos', 'Available', 3500000, 'Jl. Sosial Adil No.11, KM.2', 'Area Parkir Luas dan ada pos ronda', 40, 30, '1684651307_3344f74c3281fc275721.jpg'),
(27, 'Kos Pria Ramah Jaya', 'Togar', 1, 'WC Dalam, Dapur', 'Available', 550000, 'Jl. Keadilan Bau 2', 'Parkiran Luas', 36, 39, '1684651391_cda59eacdce00b2426ba.jpg');
...
--
ALTER TABLE `tb_hunian`
  MODIFY `id_hunian` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
