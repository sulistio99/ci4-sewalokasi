            ...
            <div class="col-sm-12 text-left menu-1">
              <ul>
                ...
                <?php if (session('id_member')) { ?>
                  <li class="<?= $menu == 'pesanan' ? 'active' : ''; ?>"><a href="<?= base_url('Home/Pesanan/' . session('id_member')); ?>">Status Sewa</a>
                  </li>
                <?php  } ?>
                <?php if (session('id_member')) { ?>
                  <li class="<?= $menu == 'sewa' ? 'active' : ''; ?>"><a href="<?= base_url('Home/Sewa/' . session('id_member')); ?>">Status Pembayaran</a>
                  </li>
                <?php  } ?>
                <?php if (session('id_member')) { ?>
      ...
      <div class="container">
        <div class="row row-pb-md">
          <div class="col footer-col colorlib-widget">
            <h4>VINS-Sewa Lokasi</h4>
            <p>Website Informasi Bagi Anda Yang Sedang Mencari Lokasi Usaha Dengan Harga Yang Terjangkau.</p>
            <ul class="colorlib-social-icons">
              <li>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae facere saepe asperiores! Iusto quis quibusdam, ratione id quo possimus maxime reiciendis nobis recusandae omnis totam consequuntur vitae, repellat eum quaerat!</p>
              </li>
            </ul>
            </p>
          </div>
          ...
          <div class="col footer-col">
            <h4>Hubungi Kami</h4>
            <ul class="colorlib-footer-links">
              <li><a href="#"><i class="icon-facebook"></i> SewaLokasi-Vins</a></li>
              <li><a href="#"><i class="icon-instagram"></i> @_VinsSewaLokasi</a></li>
              <li><a href="#"><i class="icon-mail"></i> vinssewalokasi_@yahoo.com</a></li>
              <li><a href="#"><i class="icon-whatsapp"></i> 089635789232</a></li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <p>
            <span>
              <b>
                ...
                </script> VINS - Sewa Lokasi <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Adravin</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </b>
            </span>
          </p>
